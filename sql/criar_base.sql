...
INSERT INTO BOMBAS (DESCRICAO, ID_TANQUE, STATUS, DATA_CRIACAO)
VALUES ('BOMBA GASOLINA 1', 1, 'ATIVA', CURRENT_TIMESTAMP);

INSERT INTO BOMBAS (DESCRICAO, ID_TANQUE, STATUS, DATA_CRIACAO)
VALUES ('BOMBA GASOLINA 2', 1, 'ATIVA', CURRENT_TIMESTAMP);

-- Inserir bombas para o Tanque 2 (Diesel)
INSERT INTO BOMBAS (DESCRICAO, ID_TANQUE, STATUS, DATA_CRIACAO)
VALUES ('BOMBA DIESEL 1', 2, 'ATIVA', CURRENT_TIMESTAMP);

INSERT INTO BOMBAS (DESCRICAO, ID_TANQUE, STATUS, DATA_CRIACAO)
VALUES ('BOMBA DIESEL 2', 2, 'ATIVA', CURRENT_TIMESTAMP);
